...
/**
 * [Phase 3 통합] 로직 단위 매핑 및 심층 분석 서비스
 * 단 한 번의 AI 호출로 로직 단위가 어디에 속하는지(Mapping)와 
 * 그 로직의 기술적 상세 명세(Analysis)를 동시에 수행합니다.
 */
export const analyzeAndMapUnit = async (
 ...
 동시에 해당 코드의 상세 기술 명세(Technical Specification)를 작성하십시오.
 ...
 [지시 2: 분석]
 1. 이 로직 단위가 설계상의 요구사항을 어떻게 기술적으로 충족하고 있는지 심층 분석하여 'Technical Specification'을 작성하십시오.
