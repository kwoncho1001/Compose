...
8. [중요] 폴더 및 명칭 규칙:
   ...
   - **[중요] 유사한 도메인 폴더 통합**: '디지털 캔버스', '디지털 학습캔버스', '디지털 문제 풀이 캔버스'와 같이 유사한 목적을 가진 폴더들은 반드시 하나의 대표 도메인 폴더(예: '디지털 캔버스')로 통합하십시오. 파편화된 폴더 생성을 엄격히 금지합니다.
...
3. GCM을 업데이트합니다.
4. [중요] 폴더 도메인 통합: '디지털 캔버스', '디지털 학습캔버스' 등 유사한 명칭의 폴더를 생성하지 말고, 기존의 대표 도메인 폴더로 통합하십시오. 'Imported' 및 기술 계층 폴더 사용을 금지합니다.
...
작업 목표:
1. **폴더 및 도메인 통합**: '디지털 캔버스', '디지털 학습캔버스' 등 유사한 명칭의 폴더들을 하나의 대표 도메인 폴더로 통합하십시오. 파편화된 폴더 구조를 완전히 제거하십시오.
2. **수직적 계층 구조(Hierarchy) 재구축**: 수평적으로 나열된 파편화된 노트들을 분석하여, 상위 개념의 노트를 선정하거나 생성하고 그 아래로 하위 기능들을 'parentNoteId'를 사용하여 배치하십시오. (예: '문제 스캔 및 보정' 등은 '문제 스캔' 상위 노트 아래로 이동)
...
2. **폴더 도메인 통합 및 재배치**: 유사한 명칭의 폴더(예: '디지털 캔버스' 시리즈)는 반드시 하나의 대표 도메인 폴더로 통합하십시오. 파편화된 폴더 구조를 허용하지 않습니다.
3. **수직적 계층 구조 적용**: 파편화된 세부 기능들은 상위 기능 노트를 찾아 'parentNoteId'를 설정함으로써 수직적 계층 구조를 형성하십시오. 수평적 나열을 지양하십시오.
